...
package sud_tanj.com.phr_android.Health_Data.ActiveHealthDataListLayout.Interface;
 ...
 */
public class ActiveHealthDataListRecyclerViewListener implements View.OnClickListener {
    private Integer sensorPosition;

    public ActiveHealthDataListRecyclerViewListener(Integer sensorPosition) {
